...
import { u as useHead } from './composables-B_psBJpm.mjs';
import { b as useRuntimeConfig, a as useNuxtApp, d as asyncDataDefaults, _ as _export_sfc, e as createError, f as fetchDefaults } from './server.mjs';
import { p as publicAssetsURL } from '../routes/renderer.mjs';
import { z as getRequestHeader, A as hash } from '../_/nitro.mjs';
...
const __nuxt_component_0$5 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$e, [["__scopeId", "data-v-92280280"]]), { __name: "ClientLogos" });
...
const _sfc_main$d = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "relative overflow-hidden bg-dark-900 grain-overlay" }, _attrs))} data-v-10936d5f><nav class="${ssrRenderClass([scrolled.value ? "bg-white/90 backdrop-blur-xl shadow-glass border-b border-dark-100" : "bg-transparent", "fixed top-0 left-0 right-0 z-50 transition-all duration-500"])}" data-v-10936d5f><div class="max-w-7xl mx-auto px-5 md:px-8 py-3 md:py-4" data-v-10936d5f><div class="flex items-center justify-between" data-v-10936d5f><a href="#" class="flex items-center gap-2 md:gap-3 group" data-v-10936d5f><img${ssrRenderAttr("src", _imports_0)} alt="OohhFood - Sistema de Gestão para Restaurantes" class="h-8 md:h-12 w-auto object-contain rounded-xl group-hover:scale-105 transition-transform duration-300" loading="eager" width="120" height="120" data-v-10936d5f><span class="${ssrRenderClass([scrolled.value ? "text-dark-900" : "text-white", "text-xl md:text-2xl font-display font-bold transition-colors duration-300"])}" data-v-10936d5f> Oohh<span class="text-brand-500" data-v-10936d5f>Food</span></span></a><div class="hidden md:flex items-center gap-1" data-v-10936d5f><!--[-->`);
      ssrRenderList(navLinks, (link) => {
        _push(`<a${ssrRenderAttr("href", link.href)}${ssrRenderAttr("target", link.external ? "_blank" : void 0)}${ssrRenderAttr("rel", link.external ? "noopener noreferrer" : void 0)} class="${ssrRenderClass([scrolled.value ? "text-dark-500 hover:text-dark-900 hover:bg-dark-50" : "text-white/70 hover:text-white hover:bg-white/10", "px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300"])}"${ssrRenderAttr("aria-label", link.label)} data-v-10936d5f>${ssrInterpolate(link.text)}</a>`);
      });
      _push(`<!--]--><a href="https://app.oohhfood.com.br/login" target="_blank" rel="noopener noreferrer" class="ml-3 btn-primary !py-2.5 !px-5 !text-sm !rounded-xl" aria-label="Fazer login no OohhFood (abre em nova aba)" data-v-10936d5f> Começar Agora <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-10936d5f><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" data-v-10936d5f></path></svg></a></div><button class="${ssrRenderClass([scrolled.value ? "text-dark-700 hover:bg-dark-50" : "text-white/80 hover:bg-white/10", "md:hidden p-2 rounded-xl transition-colors duration-300"])}" aria-label="Toggle menu"${ssrRenderAttr("aria-expanded", mobileMenuOpen.value)} aria-controls="mobile-menu" data-v-10936d5f>`);
      if (!mobileMenuOpen.value) {
        _push(`<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-10936d5f><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" data-v-10936d5f></path></svg>`);
      } else {
        _push(`<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-10936d5f><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" data-v-10936d5f></path></svg>`);
      }
      _push(`</button></div>`);
      if (mobileMenuOpen.value) {
        _push(`<div id="mobile-menu" class="${ssrRenderClass([scrolled.value ? "border-dark-100" : "border-white/10", "md:hidden mt-3 pb-4 space-y-1 border-t pt-4"])}" data-v-10936d5f><!--[-->`);
        ssrRenderList(navLinks, (link) => {
        ...
        _push(`<!--]--><a href="https://app.oohhfood.com.br/login" target="_blank" rel="noopener noreferrer" class="block btn-primary !text-center !text-sm mt-2" aria-label="Fazer login no OohhFood (abre em nova aba)" data-v-10936d5f> Começar Agora </a></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></nav><div class="absolute inset-0 mesh-gradient opacity-60" data-v-10936d5f></div><div class="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-brand-500/30 to-transparent" data-v-10936d5f></div><div class="relative z-10 max-w-7xl mx-auto px-5 md:px-8 pt-28 pb-12 md:pt-40 md:pb-20" data-v-10936d5f><div class="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center" data-v-10936d5f><div class="space-y-6 md:space-y-8 order-2 lg:order-1" data-v-10936d5f><div class="inline-flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-4 py-1.5 backdrop-blur-sm" data-v-10936d5f><span class="w-2 h-2 rounded-full bg-green-400 animate-pulse" data-v-10936d5f></span><span class="text-xs md:text-sm text-white/60 font-medium" data-v-10936d5f> +1.000 restaurantes já utilizam </span></div><h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-display font-bold text-white leading-[1.08] tracking-tight" data-v-10936d5f> A forma mais inteligente de gerenciar seu <span class="text-gradient" data-v-10936d5f>restaurante</span></h1><p class="text-base md:text-lg text-white/50 leading-relaxed max-w-xl font-light" data-v-10936d5f> Da cozinha ao atendimento — otimize operações, reduza desperdícios e tome decisões baseadas em dados reais. Tudo em uma plataforma. </p><div class="flex flex-col sm:flex-row gap-3 md:gap-4 pt-2" data-v-10936d5f><a href="https://app.oohhfood.com.br/signup" target="_blank" rel="noopener noreferrer" class="btn-primary !px-8 !py-4 !text-base !rounded-2xl" aria-label="Começar teste grátis do OohhFood (abre em nova aba)" data-v-10936d5f> Começar Teste Grátis <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-10936d5f><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" data-v-10936d5f></path></svg></a><a href="#features" class="inline-flex items-center justify-center gap-2 font-semibold text-white/70 hover:text-white px-8 py-4 rounded-2xl border border-white/10 hover:border-white/25 hover:bg-white/5 text-base transition-all duration-300 text-center backdrop-blur-sm" aria-label="Explorar recursos e funcionalidades do OohhFood" data-v-10936d5f> Explorar Recursos </a></div><div class="flex items-center gap-4 pt-2" data-v-10936d5f><div class="flex -space-x-2" data-v-10936d5f><!--[-->`);
      ssrRenderList(avatarColors, (color, i) => {
        _push(`<div class="${ssrRenderClass([color, "w-8 h-8 rounded-full border-2 border-dark-900 flex items-center justify-center text-[10px] font-bold text-white"])}" data-v-10936d5f>${ssrInterpolate(avatarInitials[i])}</div>`);
      });
      _push(`<!--]--></div><div class="text-sm" data-v-10936d5f><div class="flex items-center gap-1" data-v-10936d5f><!--[-->`);
      ssrRenderList(5, (i) => {
        _push(`<svg class="w-3.5 h-3.5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20" data-v-10936d5f><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" data-v-10936d5f></path></svg>`);
      });
      _push(`<!--]--></div><span class="text-white/40 text-xs" data-v-10936d5f>4.8/5 de 150+ avaliações</span></div></div></div><div class="relative order-1 lg:order-2" data-v-10936d5f><div class="absolute -inset-4 bg-brand-500/10 blur-3xl rounded-full" data-v-10936d5f></div><div class="relative" data-v-10936d5f><div class="relative rounded-3xl overflow-hidden border border-white/10 shadow-2xl" data-v-10936d5f><img${ssrRenderAttr("src", _imports_1)} alt="Sistema OohhFood - Interface de gestão de restaurante com pedidos, produtos e dashboard" class="w-full h-auto" loading="eager" width="800" height="600" data-v-10936d5f><div class="absolute inset-0 bg-gradient-to-t from-dark-900/40 via-transparent to-transparent" data-v-10936d5f></div></div><div class="hidden sm:block absolute -top-3 -right-3 md:top-4 md:-right-6 bg-white rounded-2xl shadow-glass-lg p-3 md:p-4 floating-1 max-w-[160px] md:max-w-[200px] border border-dark-100" data-v-10936d5f><div class="flex items-center gap-2 mb-2" data-v-10936d5f><div class="w-7 h-7 rounded-lg bg-brand-50 flex items-center justify-center" data-v-10936d5f><svg class="w-4 h-4 text-brand-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-10936d5f><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" data-v-10936d5f></path></svg></div><span class="text-xs font-bold text-dark-800" data-v-10936d5f>Pedidos Hoje</span></div><ul class="space-y-1.5 text-[10px] md:text-xs" data-v-10936d5f><li class="flex items-center justify-between gap-2" data-v-10936d5f><span class="text-dark-400 truncate" data-v-10936d5f>15 Hambúrgueres</span><span class="bg-green-50 text-green-600 px-1.5 py-0.5 rounded-md text-[9px] font-bold flex-shrink-0" data-v-10936d5f>Enviado</span></li><li class="flex items-center justify-between gap-2" data-v-10936d5f><span class="text-dark-400 truncate" data-v-10936d5f>6 Pastéis</span><span class="bg-yellow-50 text-yellow-600 px-1.5 py-0.5 rounded-md text-[9px] font-bold flex-shrink-0" data-v-10936d5f>Pronto</span></li><li class="flex items-center justify-between gap-2" data-v-10936d5f><span class="text-dark-400 truncate" data-v-10936d5f>8 Milk Shakes</span><span class="bg-dark-50 text-dark-400 px-1.5 py-0.5 rounded-md text-[9px] font-bold flex-shrink-0" data-v-10936d5f>Pendente</span></li></ul></div><div class="hidden sm:block absolute -bottom-3 -left-3 md:bottom-8 md:-left-6 bg-white rounded-2xl shadow-glass-lg p-3 md:p-4 floating-2 max-w-[150px] md:max-w-[180px] border border-dark-100" data-v-10936d5f><div class="flex items-center gap-2 mb-2" data-v-10936d5f><div class="w-7 h-7 rounded-lg bg-green-50 flex items-center justify-center" data-v-10936d5f><svg class="w-4 h-4 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-10936d5f><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" data-v-10936d5f></path></svg></div><span class="text-xs font-bold text-dark-800" data-v-10936d5f>Receita</span></div><div class="text-xl md:text-2xl font-display font-bold text-dark-900" data-v-10936d5f>R$ 4.280</div><div class="flex items-center gap-1 mt-1" data-v-10936d5f><span class="text-[10px] font-bold text-green-500" data-v-10936d5f>+23%</span><span class="text-[10px] text-dark-300" data-v-10936d5f>vs. ontem</span></div></div></div></div></div></div><div class="relative z-10 border-t border-white/5 py-8 md:py-12" data-v-10936d5f><div class="max-w-7xl mx-auto px-5 md:px-8" data-v-10936d5f><p class="text-center text-xs md:text-sm text-white/30 mb-6 md:mb-8 font-medium uppercase tracking-wider" data-v-10936d5f> Confiado por equipes de restaurantes de destaque </p>`);
...
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$d, [["__scopeId", "data-v-10936d5f"]]), { __name: "HeroSection" });
...
const __nuxt_component_2 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$b, [["ssrRender", _sfc_ssrRender$4]]), { __name: "FeaturesSection" });
...
const __nuxt_component_3 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$9, [["ssrRender", _sfc_ssrRender$3]]), { __name: "BenefitsSection" });
...
const __nuxt_component_4 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$2]]), { __name: "HowItWorksSection" });
...
const __nuxt_component_5 = Object.assign(_sfc_main$5, { __name: "PricingSection" });
...
//# sourceMappingURL=index-BYNmJ5o1.mjs.map
